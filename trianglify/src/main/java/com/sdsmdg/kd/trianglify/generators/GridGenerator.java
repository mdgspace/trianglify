...
public class GridGenerator {
    ...
    public void generateRectangularGrid(int width, int height, int cellSize, int variance) {
        this.grid.clear();
        this.currentGridtype = GridType.RECTANGULAR;
    ...
    public void generateCircularGrid(int width, int height, int cellSize, int variance) {
        this.grid.clear();
        this.currentGridtype = GridType.CIRCULAR;
